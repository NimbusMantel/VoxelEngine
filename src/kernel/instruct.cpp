...
static const uint8_t ins_ctg_all[INS_CTG::NUM] = { INS_CTG_MOV_C, INS_CTG_REM_C, INS_CTG_EXP_C, INS_CTG_ADD_C, INS_CTG_ULD_C, INS_CTG_RLD_C, INS_CTG_COL_C, INS_CTG_LIT_C };
